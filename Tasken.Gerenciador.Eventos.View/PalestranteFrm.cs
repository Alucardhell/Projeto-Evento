...
{
    public partial class PalestranteFrm : UserControl
    {

        private Palestrante palestranteFrm = new Palestrante();
        public PalestranteFrm()
        {
            InitializeComponent();
        }
        ...
        private void btnPesquisarPalestranteId_Click(object sender, EventArgs e)
        {
            try
            {
                FabricaRepositorio fabricarEvento = new FabricaRepositorio(ConnectionSQL.connectionString);
        ...
        private void pesquisarPalestranteTodos_Click(object sender, EventArgs e)
        {
            BuscarTodos();
        }

        private void cadastrarPalestrante_Click(object sender, EventArgs e)
        {
        ...
        private void alterarPalestrante_Click(object sender, EventArgs e)
        {
        ...
        private void excluirPalestrante_Click(object sender, EventArgs e)
        {
            if (palestranteFrm.PalestranteId != 0)
            {
        ...
        private void dataGridViewPalestrante_CellClick(object sender, DataGridViewCellEventArgs e)
        {
